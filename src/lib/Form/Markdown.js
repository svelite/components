import { component } from "svelite-html"
...
export default component({
    ...
    script: () => {
        document.addEventListener('alpine:init', () => {
            ...
            Alpine.directive('easymde', (el, { value, modifiers, expression }, { Alpine, effect, cleanup }) => {
                // el.textContent = el.textContent.toUpperCase()
                console.log('easymde init: ', el)
                console.log('second: ', { value, modifiers, expression })
                console.log('third: ', { Alpine, effect, cleanup })
...
//     <div x-easymde x-ref="textarea" id="{{id}}" x-model="value.{{name}}">
//         {{value}}
//     </div>
// </div>

// {{--  
// <textarea x-toast-markdown x-ref="textarea" id="{{id}}" x-model="value.{{name}}">
//     {{value}}
// </textarea>  --}}
// {{--  <form>  --}}
...
//             </button>
//             <div id="tooltip-fullscreen" role="tooltip" class="absolute z-10 inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700 opacity-0 invisible" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(760px, 69px);">
//                 Show full screen
//                 <div class="tooltip-arrow" data-popper-arrow="" style="position: absolute; left: 0px; transform: translate(81px, 0px);"></div>
//             </div>
//         </div>
//         <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
//             <label for="editor" class="sr-only">Publish post</label>
//             <textarea id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required="" style="height: 141px;"></textarea>
//         </div>
//     </div>
